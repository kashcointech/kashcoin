...
#if defined(NDEBUG)
# error "Kashcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Kashcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s KAC additional fees, %d delta bytes\n",
...
bool IsInitialBlockDownload()
{
    ...
    if (chainActive.Tip() == nullptr)
        return true;
    //tigle if (chainActive.Tip()->nChainWork < UintToArith256(chainParams.GetConsensus().nMinimumChainWork))
    //tigle    return true;
