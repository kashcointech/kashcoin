...
{
    const char* pszTimestamp = "AISA/SEOUL Times 15/Feb/2018 First DEPT., Coinhub, GuDi";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 2 * 24 * 60 * 60; // PoW difficulty check 
        consensus.nPowTargetSpacing = 1 * 60;		// mining interval change to 1 Min
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1550383481; // January 31st, 2019

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 1485561600; // January 28, 2017
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1550383481; //January 31st, 2019
        ...
        genesis = CreateGenesisBlock(1519535765,2083650687, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("8812b702ebe59fde397bc8e6c306eeede65d34f3e77b62d88828d80607036caf"));
        assert(genesis.hashMerkleRoot == uint256S("ae09ef3717ef9e98a8dcba7ca37f2b8f854ff6973c2b94f1240d269495d2ed5b"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("dnsseed1.inhub.co.kr", false);
        vSeeds.emplace_back("dnsseed.nkash.tech", false);
        vSeeds.emplace_back("dns.nkash-tools.net", false);
        vSeeds.emplace_back("wallet1.inhub.co.kr", false);
        ...
        chainTxData = ChainTxData{
            ...
            1517443199, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 2213503889; // January 31st, 2040 
        //consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1517356801; // January 31st, 2018

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 1483228800; // January 1, 2017
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 2213503889; // January 31st, 2040
        ...
        genesis = CreateGenesisBlock(1518677354, 2084524494, 0x200ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-dnsseed.nkash-seed.com", false);
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1518677354, 2084524494, 0x200ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("2cc533c423b1660798e4fa36ecbcc791dc4645c3f7853c8b0892cd1d96b264ea"));
        assert(genesis.hashMerkleRoot == uint256S("ae09ef3717ef9e98a8dcba7ca37f2b8f854ff6973c2b94f1240d269495d2ed5b"));
