...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kashcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kashcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kashcoin transaction") + "\n" +
              "  kashcoin-tx [options] -create [commands]   " + _("Create hex-encoded kashcoin transaction") + "\n" +
              "\n";
