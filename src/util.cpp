...
const char * const BITCOIN_CONF_FILENAME = "kashcoin.conf";
const char * const BITCOIN_PID_FILENAME = "kashcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Kashcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Kashcoin";
#else
    // Unix
    return pathRet / ".kashcoin";
#endif
#endif
}
